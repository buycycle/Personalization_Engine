...
from src.driver_content import main_query, main_query_dtype, popularity_query, popularity_query_dtype,\
    ...
    categorical_features_to_overweight, categorical_features_overweight_factor

from src.driver_collaborative import user_id, bike_id, item_features,\
    user_features, query
